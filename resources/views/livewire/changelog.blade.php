            ...
            <div class="space-y-8">
                ...
                <div>
                    <div class="flex items-baseline gap-3 mb-3">
                        <h3 class="text-2xl font-bold" style="color: var(--term-text);">v3.1.1</h3>
                        <span class="text-sm" style="color: var(--term-dim);">2026-08-06</span>
                    </div>
                    <div class="pl-4 space-y-2 text-sm">
                        <div style="color: var(--term-text);">
                            ...
                            <ul class="list-disc list-inside pl-4 mt-2 space-y-1" style="color: var(--term-dim);">
                                <li>Patched all 17 open dependency advisories (6 high) — Guzzle 7.15.3 plus transitive ip-address, js-yaml, postcss, shell-quote updates; both ecosystem audits now clean</li>
                                <li>Removed axios entirely — it was unused Laravel scaffolding shipping ~12 KB to every visitor, and the source of 6 of those advisories</li>
                            </ul>
                        </div>
                    </div>
                </div>
                ...
                <div>
                    <div class="flex items-baseline gap-3 mb-3">
                        <h3 class="text-2xl font-bold" style="color: var(--term-text);">v2.3.0</h3>
                        <span class="text-sm" style="color: var(--term-dim);">2025-12-17</span>
                    </div>
                    <div class="pl-4 space-y-2 text-sm">
                        <div style="color: var(--term-text);">
                ...
                <div>
                    <div class="flex items-baseline gap-3 mb-3">
                        <h3 class="text-2xl font-bold" style="color: var(--term-text);">v2.2.2</h3>
                    ...
                    <div class="pl-4 space-y-2 text-sm">
                        <div style="color: var(--term-text);">
                            <span style="color: #66d9ef;">🐛 Bug Fixes:</span>
                            <ul class="list-disc list-inside pl-4 mt-2 space-y-1" style="color: var(--term-dim);">
                                <li>Fixed "Theory vs Reality" table showing wrong expected values</li>
                                <li>Stats page now uses corrected probability calculations</li>
                            </ul>
                        </div>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div class="pl-4 space-y-2 text-sm">
                        <div style="color: var(--term-text);">
                            <span style="color: #66d9ef;">🐛 Bug Fixes:</span>
                            <ul class="list-disc list-inside pl-4 mt-2 space-y-1" style="color: var(--term-dim);">
                                <li>Fixed "Plays Per Day" and "Payouts Per Day" calculations using wrong start date</li>
                                <li>Now correctly uses October 15, 2025 (v1.0.0 launch date) as reference</li>
                                <li>Previously used first database entry which could be test data</li>
                            </ul>
                        </div>
                    </div>
                </div>
                ...
                <div>
                    <div class="flex items-baseline gap-3 mb-3">
                        <h3 class="text-2xl font-bold" style="color: var(--term-text);">v2.1.5</h3>
                        <span class="text-sm" style="color: var(--term-dim);">2025-10-17</span>
                    </div>
                    <div class="pl-4 space-y-2 text-sm">
                        <div style="color: var(--term-text);">
                            <span style="color: #66d9ef;">🐛 Bug Fixes:</span>
                            <ul class="list-disc list-inside pl-4 mt-2 space-y-1" style="color: var(--term-dim);">
                                <li>Fixed streaks leaderboard timestamp not updating when achieving new longest streak</li>
                                <li>Timestamp now updates immediately when you beat or tie your record</li>
                            </ul>
                        </div>
                    </div>
                </div>
                ...
                <div>
                    <div class="flex items-baseline gap-3 mb-3">
                        <h3 class="text-2xl font-bold" style="color: var(--term-text);">v2.1.4</h3>
                        <span class="text-sm" style="color: var(--term-dim);">2025-10-17</span>
                    </div>
                    <div class="pl-4 space-y-2 text-sm">
                        <div style="color: var(--term-text);">
                            <span style="color: #66d9ef;">🐛 Bug Fixes:</span>
                            <ul class="list-disc list-inside pl-4 mt-2 space-y-1" style="color: var(--term-dim);">
                                <li>Fixed pattern names in theory vs reality table (consistent ALL CAPS)</li>
                                <li>Added ONE PAIR to theory vs reality table</li>
                                <li>Fixed ALL NUMBERS probability calculation (1/485 instead of 1/27)</li>
                            </ul>
                        </div>
                        <div class="mt-3" style="color: var(--term-text);">
                            <span style="color: #66d9ef;">♻️ Refactoring:</span>
                            <ul class="list-disc list-inside pl-4 mt-2 space-y-1" style="color: var(--term-dim);">
                                <li>Removed "Highest Payouts" and "Rarest Patterns" sections from stats page</li>
                            </ul>
                        </div>
                    </div>
                </div>
                ...
                <div>
                    <div class="flex items-baseline gap-3 mb-3">
                        <h3 class="text-2xl font-bold" style="color: var(--term-text);">v2.1.2</h3>
                        <span class="text-sm" style="color: var(--term-dim);">2025-10-17</span>
                    </div>
                    <div class="pl-4 space-y-2 text-sm">
                        <div style="color: var(--term-text);">
                            <span style="color: #66d9ef;">🎨 UI/UX:</span>
                            <ul class="list-disc list-inside pl-4 mt-2 space-y-1" style="color: var(--term-dim);">
                                <li>Increased significant digits in theory vs reality table (4 decimals)</li>
                                <li>Negative variance now displays in red for better visibility</li>
                                <li>All patterns remain visible including ultra-rare ones</li>
                            </ul>
                        </div>
                    </div>
                </div>
                ...
                <div>
                    <div class="flex items-baseline gap-3 mb-3">
                        <h3 class="text-2xl font-bold" style="color: var(--term-text);">v2.1.1</h3>
                        <span class="text-sm" style="color: var(--term-dim);">2025-10-17</span>
                    </div>
                    <div class="pl-4 space-y-2 text-sm">
                        <div style="color: var(--term-text);">
                            <span style="color: #66d9ef;">🐛 Bug Fixes:</span>
                            <ul class="list-disc list-inside pl-4 mt-2 space-y-1" style="color: var(--term-dim);">
                                <li>Fixed ONE PAIR pattern highlighting in odds table</li>
                                <li>Increased stats precision (2-3 decimals in theory vs reality table)</li>
                            </ul>
                        </div>
                        <div class="mt-3" style="color: var(--term-text);">
                            <span style="color: #66d9ef;">♻️ Refactoring:</span>
                            <ul class="list-disc list-inside pl-4 mt-2 space-y-1" style="color: var(--term-dim);">
                                <li>Extracted hash highlighting to app.js (proper Vite pipeline)</li>
                                <li>Removed duplicate scripts from odds and leaderboard pages</li>
                            </ul>
                        </div>
                    </div>
                </div>
                ...
                <div>
                    <div class="flex items-baseline gap-3 mb-3">
                        <h3 class="text-2xl font-bold" style="color: var(--term-text);">v2.1.0</h3>
                        <span class="text-sm" style="color: var(--term-dim);">2025-10-17</span>
                    </div>
                    <div class="pl-4 space-y-2 text-sm">
                        <div style="color: var(--term-text);">
                            <span style="color: var(--term-win);">✨ New Features:</span>
                            <ul class="list-disc list-inside pl-4 mt-2 space-y-1" style="color: var(--term-dim);">
                                <li><strong>ONE PAIR pattern</strong> - New break-even at +10 points (~1 in 7 commits)</li>
                                <li>Exactly one consecutive pair (e.g., <code>aa1b3d5</code>)</li>
                            </ul>
                        </div>
                        <div class="mt-3" style="color: var(--term-text);">
                            <span style="color: #66d9ef;">⚡ Balance Changes:</span>
                            <ul class="list-disc list-inside pl-4 mt-2 space-y-1" style="color: var(--term-dim);">
                                <li><strong>ALL NUMBERS</strong> payout increased: 10 → 50 points</li>
                                <li>Pattern now properly rewarded for its rarity (1 in 485)</li>
                                <li>Break-even role moved to ONE PAIR</li>
                            </ul>
                        </div>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div class="pl-4 space-y-2 text-sm">
                        <div style="color: var(--term-text);">
                            <span style="color: #66d9ef;">🐛 Bug Fixes:</span>
                            <ul class="list-disc list-inside pl-4 mt-2 space-y-1" style="color: var(--term-dim);">
                                <li>API: Fixed streak timestamp not updating on new records</li>
                            </ul>
                        </div>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div class="pl-4 space-y-2 text-sm">
                        <div style="color: var(--term-text);">
                            <span style="color: #66d9ef;">🐛 Bug Fixes:</span>
                            <ul class="list-disc list-inside pl-4 mt-2 space-y-1" style="color: var(--term-dim);">
                                <li>Web stats: Fixed pattern display names and probabilities</li>
                            </ul>
                        </div>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div class="pl-4 space-y-2 text-sm">
                        <div style="color: var(--term-text);">
                            <span style="color: #66d9ef;">🎨 UI/UX:</span>
                            <ul class="list-disc list-inside pl-4 mt-2 space-y-1" style="color: var(--term-dim);">
                                <li>Web stats: Improved theory vs reality table readability</li>
                            </ul>
                        </div>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div class="pl-4 space-y-2 text-sm">
                        <div style="color: var(--term-text);">
                            <span style="color: #66d9ef;">🐛 Bug Fixes:</span>
                            <ul class="list-disc list-inside pl-4 mt-2 space-y-1" style="color: var(--term-dim);">
                                <li>Fixed ONE PAIR pattern highlighting in web odds table</li>
                            </ul>
                        </div>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div class="pl-4 space-y-2 text-sm">
                        <div style="color: var(--term-text);">
                            <span style="color: var(--term-win);">✨ New Features:</span>
                            <ul class="list-disc list-inside pl-4 mt-2 space-y-1" style="color: var(--term-dim);">
                                <li><strong>ONE PAIR pattern</strong> - New break-even at +10 points</li>
                                <li>Exactly one consecutive pair (e.g., <code>aa1b3d5</code>)</li>
                                <li>Occurs in ~14% of commits (~1 in 7)</li>
                            </ul>
                        </div>
                        <div class="mt-3" style="color: var(--term-text);">
                            <span style="color: #66d9ef;">⚡ Balance Changes:</span>
                            <ul class="list-disc list-inside pl-4 mt-2 space-y-1" style="color: var(--term-dim);">
                                ...
                                <li>Pattern now properly rewarded for its rarity (1 in 485)</li>
                                <li>Break-even role moved to ONE PAIR</li>
                                <li>Pattern detection priority updated</li>
                            </ul>
                        </div>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div class="pl-4 space-y-2 text-sm">
                        <div style="color: var(--term-text);">
                            <span style="color: #ff6b6b;">⚠️ Breaking Changes:</span>
                            <ul class="list-disc list-inside pl-4 mt-2 space-y-1" style="color: var(--term-dim);">
                                <li><strong>Complete payout rebalancing</strong> based on actual probabilities</li>
                                <li>Patterns now ordered by rarity (rarest first)</li>
                                <li>Top-tier payouts massively increased: JACKPOT 10K → 100K, LUCKY SEVEN 2.5K → 50K, BIG STRAIGHT 500 → 25K</li>
                                <li>Mid-tier balanced: HEXTET 5K → 10K, FULLEST HOUSE 2K → 5K, STRAIGHT 200 → 2.5K, FIVE OF A KIND 1K → 2K</li>
                                <li>Common patterns remain profitable: THREE OF A KIND 50 → 100, TWO PAIR 50 → 25, ALL NUMBERS 10 (unchanged)</li>
                            </ul>
                        </div>
                    </div>
                </div>
